...
def index(request):
    ...
    num_particular_books = Book.objects.filter(title__startswith='book').count()
...
class LoanedAllBooksByUserListView(PermissionRequiredMixin, generic.ListView):
    permission_required = 'catalog.can_mark_returned'
    model = BookInstance
    template_name = 'catalog/all_borrowed_bookinctance.html'
    paginate_by = 10
